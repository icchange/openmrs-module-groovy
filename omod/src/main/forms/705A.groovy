...
*	Who?	When?		What?
*----------------------------------------------------
*	ARS		22/MAR/15	Fixed the gregorian calendar
*						problem (KMRI-593)
*****************************************************/
...
use(TimeCategory)
{
	...
	def referenceDate = getGregorianCalendar(strDateFormat, fromDate);
	referenceDate.setTime(referenceDate.getTime()-5.years);
	def birthDateRestriction = referenceDate.format('yyyy-M-d')
	def toDateTemp = getGregorianCalendar(strDateFormat, toDate);
